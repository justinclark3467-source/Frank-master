...
**Business Type/Industry:** _______________________

**Business Location(s):** _______________________

**Owner/Decision Maker Name:** _______________________

**Email (for reports & communication):** _______________________
...
- [ ] No - You'll create everything from scratch
- [ ] I can provide some but need most created

**Are there any topics/themes you want us to avoid?**
_______________________
...
**If yes:**
- What email platform do you use? _______________________
- Login credentials we'll need: _______________________
...
- Can you provide API access or login? _______________________
- What data do you want synced? _______________________

**Do you use a booking/scheduling system?**
- [ ] Yes - Which one? _______________________
- [ ] No

**If yes:**
- Platform name: _______________________
- Can we connect to show availability in posts? _______________________

**Do you use email marketing (Mailchimp, Klaviyo, etc.)?**
- [ ] Yes - Which one? _______________________
- [ ] No
...
## SECTION 10: COMPETITION & REFERENCES

**Who are your main competitors? (List 3-5)**
_______________________

**Do you have any competitors' social media you admire?**
- [ ] Yes - Links: _______________________
- [ ] No

**Is there a business or brand (even outside your industry) whose social media style you like?**
- [ ] Yes - Name/Link: _______________________
- [ ] No - I'm open to your recommendations

---

## SECTION 11: REFERENCES & CASE STUDIES

**Can we use your business name as a case study?**
- [ ] Yes - Full name
- [ ] Yes - First name only
- [ ] No - Keep it anonymous

**Can we use your testimonials/reviews?**
- [ ] Yes
- [ ] No

**Would you be willing to provide a video testimonial if our work leads to measurable results?**
- [ ] Yes
- [ ] Maybe
- [ ] No
...
## SECTION 12: TIMELINE & APPROVAL

**Who needs to approve posts before they go live?**
- Name: _______________________
- Email: _______________________
- How do they want to receive for approval? _______________________

**What's your preferred turnaround time for approvals?**
- [ ] Same day
- [ ] 24 hours
- [ ] 48 hours
- [ ] No approval needed - post and go
...
**Quote Total:** $___________

**Setup Fee:** $___________

**Total First Month:** $___________
