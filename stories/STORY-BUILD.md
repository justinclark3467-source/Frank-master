# Frank's Letters - Story Building Guide

## Overview
Two parallel storylines running simultaneously:
...
### Tone (SAME MAILING, DIFFERENT TONES)
- **Ma letters:** Softer, protective, truthful but less harsh. Frank shields Ma from worst details.
...
### Format
- Ma letters: 850-950 words
- Joey letters: 400-450 words

## Character Names
- Frank = "Pepper" (Lucia's nickname)
- Ma = Frank's mother
- Joey = Frank's brother
- PA = Frank's deceased father (Ma writes diary to him)
- Lucia = Girl in the grove, resistance worker

## Story Timeline
1. Frank arrives in Italy (Ma 1, Joey 1)
2. Finds grove, meets Lucia (Ma 5+, Joey 5+)
3. Discovers tunnels (Ma 15-18)
4. Refugee mission (Ma 19)
5. Battle, Frank injured (Ma 20)
6. War ends (Ma 21)
7. Frank comes home - SEA VOYAGE (Ma 22, Joey 22)
8. Home, Joey meets Lucia (Ma 23 diary)
9. Frank & Lucia leave for Italy (Ma 23)
10. Future (Ma 24, Joey 24)

## Greek Saga (Home Defense)
- Joey 15-19: Greek escalates threats
- Joey 20: Greek defeated (break-in)
- Joey 21: Store reopens
- Joey 22: Frank asks about Greek
- Ma 23: Ma tells full story in diary

## Ma 23 Must Include
- Joey's bravery (Greek story)
